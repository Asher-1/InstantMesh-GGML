...
ROOT = os.path.join(os.path.dirname(__file__), "..")            # cpp_ggml/ (benchmarks/mv, pytorch_ref)
REPO_ROOT = os.path.join(os.path.dirname(__file__), "..", "..")  # repo root (official Python src/, configs/)
...
CONFIG = os.path.join(REPO_ROOT, "configs", "instant-mesh-large.yaml")
